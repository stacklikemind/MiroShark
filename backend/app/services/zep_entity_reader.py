...
class ZepEntityReader:
    ...
    def filter_defined_entities(
        ...
        Filtering logic:
        - If a node's Labels only contain "Entity", the entity doesn't match our predefined types, skip it
        - If a node's Labels contain labels beyond "Entity" and "Node", it matches a predefined type, keep it
        ...
        for node in all_nodes:
            ...
            # Filtering logic: Labels must contain labels beyond "Entity" and "Node"
